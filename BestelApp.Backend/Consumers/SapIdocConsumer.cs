...
namespace BestelApp.Backend.Consumers
{
    public class SapIdocConsumer : BackgroundService
    {
        ...
        public SapIdocConsumer(ILogger<SapIdocConsumer> logger)
        {
            _logger = logger;
            InitializeRabbitMQ();
        }
        ...
        private void InitializeRabbitMQ()
        {
            try
            {
                ...
                _logger.LogInformation($"✅ SapIdocConsumer ready for queue: {QueueName}");
            }
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (model, ea) =>
            {
                ...
                _logger.LogInformation($"📨 Received for SAP iDoc: {message}");
